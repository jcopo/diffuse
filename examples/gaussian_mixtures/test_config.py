...
from diffuse.integrator.deterministic import (
    DDIMIntegrator, DPMpp2sIntegrator, EulerIntegrator, HeunIntegrator
)
...
from examples.gaussian_mixtures.initialization import init_simple_mixture, init_grid_mixture


# Simple, unified configuration
CONFIG = {
    "schedules": {
        "LinearSchedule": {"b_min": 0.02, "b_max": 5.0},
...
def create_basic_setup(key=None, **overrides):
    ...
    forward_model = MatrixProduct(A=A, std=params["sigma_y"])
